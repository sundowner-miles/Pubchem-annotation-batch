...
parser.add_argument("--file_path", "-f", default="../ITCM/Herb-Ingredient_csmiles_replaced.csv", help="输入表路径（例如 ../ITCM/Herb-Ingredient_csmiles_replaced.csv）")
parser.add_argument("--cid", default="Ingredient Pubchem CID", help="CID 列名")
parser.add_argument("--smiles", default="cSMILES", help="SMILES 列名")
parser.add_argument("--out", default="smiles_annotation关联结果.csv", help="输出文件路径（可选）")
